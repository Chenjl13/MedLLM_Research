...
if [[ "$DATASET_SPLIT" == "pathvqa" ]]; then
    QUESTION_FILE="./data/PathVQA/test.jsonl"
    IMAGE_FOLDER="./data/PathVQA"
elif [[ "$DATASET_SPLIT" == "slake-vqarad" ]]; then
    QUESTION_FILE="./data/Slake-VQARad/test.jsonl"
    IMAGE_FOLDER="./data/Slake-VQARad"
elif [[ "$DATASET_SPLIT" == "derm" ]]; then
    QUESTION_FILE="./data/Fitzpatrick/test.jsonl"
    IMAGE_FOLDER="./data/Fitzpatrick"
elif [[ "$DATASET_SPLIT" == "CXP" ]]; then
    QUESTION_FILE="./data/CXP/test.jsonl"
    IMAGE_FOLDER="./data/CXP"
elif [[ "$DATASET_SPLIT" == "HAM" ]]; then
    QUESTION_FILE="./data/HAM/test.jsonl"
    IMAGE_FOLDER="./data/HAM"
elif [[ "$DATASET_SPLIT" == "PCAM" ]]; then
    QUESTION_FILE="./data/PCam/test.jsonl"
    IMAGE_FOLDER="./data/PCam"
elif [[ "$DATASET_SPLIT" == "iu-x-ray" ]]; then
    QUESTION_FILE="./data/IU-X-Ray/test.jsonl"
    IMAGE_FOLDER="./data/IU-X-Ray"
elif [[ "$DATASET_SPLIT" == "nmi" ]]; then
    QUESTION_FILE="./data/WSI-DX/test.jsonl"
    IMAGE_FOLDER="./data/WSI-DX"
fi
